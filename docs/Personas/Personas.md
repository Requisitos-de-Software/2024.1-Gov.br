...
<p style="text-align: center"><b>Tabela 1</b> - Persona Secundária João Silva.</p>
...
| **Objetivo:** João foi orientado por seu filho Pedro a usar o aplicativo gov.br para solicitar agendamento para a Receita Federal, diretamente do app. Seu objetivo é encontrar o serviço rapidamente, realizar suas pendências e depois fechar o app, pois ele não costuma utilizá-lo para outras tarefas, e geralmente fica apenas em um único objetivo. |
| **Expectativa:** João espera que o aplicativo gov.br seja fácil de usar, mesmo para alguém com pouca experiência em smartphones. Ele quer uma forma rápida e segura de encontrar o serviço desejado. Privacidade e segurança são importantes para ele ao lidar com informações sensíveis.|
| **Tarefas:** João começa seu dia cedo, revisando planos de construção e se preparando para o trabalho.|
...
|**Objetivo:** Instalou o app gov.br para acessar serviços relacionados à assinatura digital. Precisa estar sempre assinando documentos sobre os processos de seus clientes e deseja diminuir o seu trabalho.|
|**Expectativa:** Navegação rápida e fácil para acessar a função de assinatura digital. Interface intuitiva para busca de processos e documentos. Segurança na transmissão e armazenamento de documentos sensíveis.|
...
<p style="text-align: center"><b>Tabela 3</b> - Persona Secundária Rafael Pedrosa.</p>
...
| **Habilidades e Experiências:** Especializado em História Moderna, dá aulas em uma escola pública de ensino médio em Brasília. Tem habilidades em pesquisa histórica e métodos de ensino inovadores.|
...
| **Objetivo:** Instalou o app gov.br para utilizar o aplicativo Gov.br principalmente para acessar serviços governamentais online, como agendamento de atendimentos em órgãos públicos, consulta de informações sobre benefícios sociais e acompanhamento de processos relacionados à sua carreira.|
| **Expectativa:** Facilidade de acesso aos serviços governamentais, eficiência no agendamento de atendimentos e acompanhamento de processos, transparência nas informações, recebimento de atualizações e notificações relevantes, e garantia de segurança e privacidade das informações pessoais.|
...
|**Objetivo:** Instalou o app gov.br para acessar as funções de carteira digital.|
|**Expectativa:**  Busca substituir completamente a sua carteira física. Desejar se capaz de acessar rápidamente os seus documentos a partir de seu celular sem a necessidade de documentos físicos. Acesso fácil aos documentos mesmo sem conexão com a internet.|
...
<p style="text-align: center"><b>Tabela 5</b> - Persona Primária Olimar Gonçalves.</p>
...
|**Relacionamentos:** Casado. Mantém relativo contato com seus antigos amigos professores.|
|**Objetivo:** Foi orientado pela sua família a instalar o app gov.br para acessar recursos relacionados à sua aposentadoria.|
